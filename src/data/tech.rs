...
pub fn default_tech_tree() -> Vec<TechNode> {
    vec![
        ...
        TechNode::new(
            "masonry",
            "Basic Masonry",
            "Better construction techniques increase production by 10%.",
            5.0,
            None,
            TechEffect::ProductionMulti(1.1),
            0.0,
            0.0,
        ),
        // Tier 2: Specialized
        TechNode::new(
            "logistics",
            "Logistics",
            "Optimized paths reduce maintenance costs by 15%.",
            15.0,
            Some("masonry"),
            TechEffect::EfficiencyMulti(0.85),
            -100.0,
            100.0,
        ),
        TechNode::new(
            "urban_planning",
            "Urban Planning",
            "Proper zoning makes the town more attractive.",
            20.0,
            Some("masonry"),
            TechEffect::AttractivenessFlat(0.5),
            100.0,
            100.0,
        ),
        // Tier 3: Expansion
        TechNode::new(
            "insulation",
            "Better Insulation",
            "Warm homes allow for higher housing density (+5 Capacity).",
            50.0,
            Some("urban_planning"),
            TechEffect::HousingGlobal(5.0),
            100.0,
            200.0,
        ),
        TechNode::new(
            "automation",
            "Renovation Tools",
            "Advanced tools drastically boost production (+25%).",
            75.0,
            Some("logistics"),
            TechEffect::ProductionMulti(1.25),
            -100.0,
            200.0,
        ),
    ]
